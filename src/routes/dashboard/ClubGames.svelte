...
<!-- <div class="is-flex is-justify-content-space-between is-fullwidth">
	<h2 class="title page-heading is-3 is-uppercase mb-0">Club Games</h2> 
	<button class="button controlBtn is-warning is-uppercase has-text-grey" on:click={toggleForm}>
	  {#if showForm}Hide Add Game Form{:else}ShowAdd Game Form{/if}
	</button>
  </div> -->

<!-- <h2 class="title page-heading is-3 is-uppercase mb-0">Club Games</h2> 
<button on:click={toggleForm}>
	{#if showForm}Hide Form{:else}Show Form{/if}
</button> -->
